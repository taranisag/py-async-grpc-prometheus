...
@typing_extensions.final
class MultipleHelloResRequest(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
    ...
    def ClearField(self, field_name: typing_extensions.Literal["name", b"name", "res", b"res"]) -> None: ...

global___MultipleHelloResRequest = MultipleHelloResRequest
