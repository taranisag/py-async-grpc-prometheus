...
async def test_grpc_server_handled_with_normal(target_count, grpc_stub: GrpcStub):
    responses = []
...
async def test_grpc_server_handled_with_stream_unary(
    number_of_names, grpc_stub, stream_request_generator
):
    responses = []
    responses.append(
        await grpc_stub.stub.SayHelloStreamUnary(
...
async def test_grpc_server_handled_with_bidi_stream(
    number_of_names, number_of_res, grpc_stub, bidi_request_generator
):
    responses = []
